...
- ⏳ **Lead Generation** — модальные формы (запись на тест-драйв, кредит, trade-in)
- ⏳ **Калькуляторы** — кредитный, trade-in, оценка автомобиля
...
- [ ] Модальная форма записи на тест-драйв
- [ ] Кредитный калькулятор (ежемесячный платеж)
- [ ] Калькулятор Trade-in
- [ ] Элементы срочности (оставшиеся авто, таймеры)
- [ ] Интеграция Telegram для уведомлений
- [ ] Полноэкранная модалка для мобильных
