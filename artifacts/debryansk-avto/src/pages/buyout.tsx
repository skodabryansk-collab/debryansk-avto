        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-3xl">
          ...
          <FadeIn delay={0.08} className="space-y-4">
            <p className="text-sm text-slate-600 leading-relaxed">
              Продать автомобиль в Брянске можно двумя способами — и оба ведут к результату быстрее, чем самостоятельные объявления на Авито или Авто.ру. Срочный выкуп подходит, если деньги нужны сегодня: называете марку, модель и пробег — через 15 минут называем диапазон цены по телефону. Итоговую сумму подтвердим после бесплатного осмотра, деньги переводятся в день сделки, все документы на снятие с учёта оформляем сами.
            </p>
            <p className="text-sm text-slate-600 leading-relaxed">
              Комиссионная продажа выгоднее по итоговой сумме, если время не критично. Автомобиль размещается одновременно на Авито, Авто.ру, Дром и в нашем каталоге — это одна из крупнейших площадок продажи автомобилей в Брянске, поэтому предложение видит больше потенциальных покупателей, чем при частном объявлении. Пока машина ждёт покупателя, она хранится на охраняемой стоянке бесплатно — рисковать оставлять её во дворе не нужно.
            </p>
            <p className="text-sm text-slate-600 leading-relaxed">
              Как официальный дилер с 15-летней историей на рынке Брянска мы работаем по договору и с реальной оценкой — без искусственного занижения цены, распространённого у частных перекупщиков. Оценка всегда бесплатна и ни к чему не обязывает: можно узнать цену и решить не продавать.
            </p>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-4 gap-4">
            {[
              ...
              { n: "03", title: "Осмотр на месте",       desc: "Принимаем на нашей площадке — осмотр всегда бесплатный" },
