  ...
  return (
    <Layout>
      ...
      <div>
        ...
        <section aria-labelledby="service-sources" className="py-8 sm:py-10 bg-white border-t border-slate-100">
          <div className="container mx-auto px-4 sm:px-6 max-w-3xl">
            <h2 id="service-sources" className="text-lg sm:text-xl font-extrabold mb-3">Полезные официальные источники</h2>
            <p className="text-sm text-slate-500 leading-relaxed mb-3">
              Требования к регистрации автомобиля и общие правила участия в дорожном движении уточняйте на официальных ресурсах государственных органов.
            </p>
            <ul className="flex flex-wrap gap-x-5 gap-y-2 text-sm">
              ...
              <li><a href="https://www.cbr.ru/" target="_blank" rel="noopener noreferrer" className="text-[#0070b8] font-semibold hover:underline">Банк России</a></li>
            </ul>
          </div>
        </section>
