...
const FAQ_SEED = [
  // === brands/haval-pro (7) ===
  { page_slug: "brands/haval-pro", question: "Какая гарантия на новый Haval Pro?", answer: "3 года или 150 000 км пробега на узлы и компоненты при заводском дефекте. Отдельно — 6 лет от сквозной коррозии кузова независимо от пробега. Для авто 2023 года выпуска и новее действует постгарантийная программа ещё на 2 года/150 000 км. Гарантия при прохождении ТО у официального дилера Дебрянск Авто.", include_in_schema: true, sort_order: 1 },
  { page_slug: "brands/haval-pro", question: "Чем Haval Pro отличается от Haval City?", answer: "Haval Pro — внедорожники и рамные внедорожники (H3, H5, H7, H9) для бездорожья и экстремальных условий. Haval City — городские кроссоверы и пикапы (M6, Jolion, Dargo, F7, Poer). Обе линейки представлены в отдельных дилерских центрах Дебрянск Авто в Брянске.", include_in_schema: true, sort_order: 2 },
  { page_slug: "brands/haval-pro", question: "Какие модели Haval Pro есть в наличии в Брянске?", answer: "H3, H5, H7, H9 — в наличии разных комплектаций и цветов. Актуальный каталог с ценами на странице бренда, обновляется в реальном времени. Под заказ — любая конфигурация из модельного ряда.", include_in_schema: false, sort_order: 3 },
  { page_slug: "brands/haval-pro", question: "Дебрянск Авто — официальный дилер Haval Pro в Брянске?", answer: "Да, официальный дилер Haval Pro с 2011 года, часть группы компаний «Дебрянск Авто — Территория Автомобилей». Дилерский центр — пр. Московский, 2Г, Брянск.", include_in_schema: true, sort_order: 4 },
  { page_slug: "brands/haval-pro", question: "Можно ли купить Haval Pro в кредит у дилера в Брянске?", answer: "Да, действуют кредитные программы от банков-партнёров HAVAL для покупки внедорожников Haval Pro. Точный расчёт — у менеджера дилерского центра Дебрянск Авто.", include_in_schema: true, sort_order: 5 },
  { page_slug: "brands/haval-pro", question: "Принимаете ли вы авто в trade-in при покупке Haval Pro?", answer: "Да, любой автомобиль, не только Haval. Бесплатная оценка — около 30 минут, сумма сразу идёт в зачёт нового внедорожника в любом дилерском центре на территории Дебрянск Авто.", include_in_schema: true, sort_order: 6 },
  { page_slug: "brands/haval-pro", question: "Как записаться на ТО для Haval Pro в Брянске?", answer: "Записаться на техническое обслуживание Haval Pro можно онлайн на сайте или по телефону дилерского центра на пр. Московский, 2Г. Интервал ТО зависит от модели и условий эксплуатации.", include_in_schema: true, sort_order: 7 },
